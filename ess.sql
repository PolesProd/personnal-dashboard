...
INSERT INTO `users` (`id`, `nom`, `prenom`, `fonction`, `structure`, `code_postal`, `ville`, `email`, `lienThumb`) VALUES (1, 'ROBERT', 'Laurent ', 'Chargé de développement', 'CAPIC78 - Filia- WebForce3', 78114, 'Magny les Hameau', 'laurent.robert44@gmail.com', 'img/wf3.jpg'),
