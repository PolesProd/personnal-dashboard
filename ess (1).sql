...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 21 Septembre 2016 à 10:11
...
--
-- Structure de la table `users_thumb`
--

CREATE TABLE `users_thumb` (
...
--
-- Index pour la table `users_thumb`
--
ALTER TABLE `users_thumb`
...
--
-- AUTO_INCREMENT pour la table `users_thumb`
--
ALTER TABLE `users_thumb`
...
--
-- Contraintes pour la table `users_thumb`
--
ALTER TABLE `users_thumb`
  ADD CONSTRAINT `users_thumb_ibfk_1` FOREIGN KEY (`user_id_fk`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
